describe('Tests para la vista sesiones', () => {
  ...
  it.skip('Generar PDF', () => {
    ...
    cy.get('.divExtras > :nth-child(2) > input').type(10)
  ...
  it.skip('Modificar sesión', () => {
    ...
    cy.get(':nth-child(3) > .text-center > .d-flex > .btn-info').click({ force: true })
  ...
  it.skip('Eliminar sesión', () => {
    ...
    cy.visit('https://127.0.0.1:8000/session')
    cy.get(':nth-child(4) > .page-link').click()
    cy.get(':nth-child(3) > .text-center > .d-flex > .btn-danger').click({ force: true })
    cy.wait(3000)
